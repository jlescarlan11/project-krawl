...
export default function Error({
  ...
  useEffect(() => {
    ...
    console.error("Gem detail page error:", error);
  }, [error]);
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary">
              We encountered an error while loading this gem. This could be due
              to a network issue or the gem data being temporarily unavailable.
            </p>
          </div>
