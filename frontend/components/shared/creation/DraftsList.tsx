...
/**
 * Generic DraftsList Props
 *
 * This component is a shared implementation for both Gem and Krawl draft lists.
 * It's designed to be highly configurable through props to support different entity types.
 */
export interface DraftsListProps {
  /** Type of draft being displayed ('gem' or 'krawl') */
  draftType: 'gem' | 'krawl';
  ...
  /** Function to get human-readable step name from step number */
  getStepName: (step: number) => string;

  /** Function to extract preview text from draft data */
  getDraftPreview: (draft: Draft) => string;

  /** Route to navigate to when resuming a draft */
  createRoute: string;
 ...
 *
 * A generic component for displaying saved creation drafts.
...
export function DraftsList({
  ...
  // Load drafts on mount or when session changes
  useEffect(() => {
    if (session?.user) {
      loadDraftsData();
    }
