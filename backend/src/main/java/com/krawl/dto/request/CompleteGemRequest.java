...
public class CompleteGemRequest {
    ...
    @Schema(
        description = "Gem ID to mark as completed", 
        example = "123e4567-e89b-12d3-a456-426614174000", 
        requiredMode = Schema.RequiredMode.REQUIRED // Changed from required = true
    )
    ...
    @Schema(
        description = "Arrival method: AUTOMATIC (geofencing) or MANUAL (user marked)", 
        example = "AUTOMATIC", 
